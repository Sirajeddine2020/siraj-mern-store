                ...
                <div className="Content">
                    <div className="ProductDetailsWrapper">
                        <div className="ProductDetailsImage">
                            ...
                            <div className="ActionButtonWrapper">
                                <button onClick={() => { this.addToCart(product._id, product.price, product.name, product.productPic[0]) }}><i className="fas fa-shopping-cart"></i>&nbsp;ADD TO CART</button>
                                <button style={{background: '#fb641b'}}><i className="fas fa-bolt"></i>&nbsp;BUY NOW</button>
                            </div>
                        </div>
                        <div className="ProductDetails">
                            <div className="BreadCrumb">
                                <small>Home &gt; {product.category.parent} &gt; {product.category}</small>
                            </div>
                            <p className="ProductTitle">{product.name}</p>
                            <p className="ProductPrice">${product.price}</p>
                            <div className="ProductDescription">
                                <h3>Product Description</h3>
                                <p style={{color: 'red', float:'center'}}>{product.description}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="SimilarProducts">
                        ...
                        <div className="SimilarProductsWrapper">
                            ...
                            <div className="SimilarProduct">
                                <div className="SimilarProductImage">
                                    <img src="https://productimages.hepsiburada.net/s/18/280-413/9801258696754.jpg?v1" alt=""/>
                                </div>
                                <div className="SimilarProductDetails">
                                    <h5>Product Name</h5>
                                    <p>$ 899</p>
