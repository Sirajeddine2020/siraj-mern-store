...
class Products extends Component{
    ...
    applyFilter = (filter) => {
        const category = this.props.match.params.category === 'all' ? '' : this.props.match.params.category
                    ...
                    <div className="ContentBody">
                        <div className="SideMenu">
                           ...
                           <div className="Filter">
                               ...
                               <div>
                                    { <button onClick={() => this.props.sortProducts(this.props.products.products,"lowestprice")} className="FilterButton">Low to High</button> }
                               </div>
                               <div>
                                   { <button onClick={() => this.props.sortProducts(this.props.products.products,"highestprice")} className="FilterButton">High to Low</button> }
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        sortProducts: (items, sort) => dispatch(productActions.sortProducts(items, sort)),
